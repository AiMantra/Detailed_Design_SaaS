...
/** DPR & Prebid: client/branch (and some units) optional */
export function isRelaxedProjectType(sourceId) {
  return (
    sourceId === PROJECT_SOURCE_IDS.DPR || sourceId === PROJECT_SOURCE_IDS.PREBID
  );
}
...
/** Filter a project list by type key (`all` | `detail design` | `dpr` | `prebid`). */
